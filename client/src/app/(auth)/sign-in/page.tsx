      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_.85fr] lg:items-start">
          <section className="pt-2 lg:pt-12">
            <LegalBridgeLogo />
            <p className="mt-8 text-xs font-bold uppercase tracking-[0.18em] text-[var(--saffron-dark)]">Persistent casework workspace</p>
          ...
          <Card className="shadow-xl">
            ...
            <CardContent className="p-6">
              <div className="mb-6 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-950">
                <div className="flex items-center gap-2 font-semibold"><ShieldAlert className="size-4" aria-hidden="true" /> Primary casework credentials</div>
                <dl className="mt-3 grid gap-2 text-xs sm:grid-cols-[5rem_1fr]">
                  <dt className="font-semibold">Workspace</dt><dd className="break-all font-mono">legalbridge-casework</dd>
                  <dt className="font-semibold">Email</dt><dd className="break-all font-mono">admin@legalbridge.in</dd>
                  <dt className="font-semibold">Password</dt><dd className="break-all font-mono">LegalBridgeAdmin@2026</dd>
                </dl>
              </div>
